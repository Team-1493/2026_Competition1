...
class AutoPilotCommandToShoot(commands2.Command):
    ...
    def __init__(self,m_drivetrain:CommandSwerveDrivetrain):
        ...
        self.pose_blue_right_1 =Pose2d(Translation2d(6.0, 2.45),Rotation2d(35*pi/180))

        self.pose_blue_left_2 =Pose2d(Translation2d(2.784, 8.069-2.591),Rotation2d(-35*pi/180)) 
        self.pose_blue_left_1 =Pose2d(Translation2d(6.0, 5.5),Rotation2d(-35*pi/180))

        self.pose_red_right_2 =Pose2d(Translation2d(16.54-2.784, 8.069-2.591),Rotation2d(35*pi/180+pi)) 
        self.pose_red_right_1 =Pose2d(Translation2d(16.54 - 6.0, 5.5),Rotation2d(35*pi/180+pi))

        self.pose_red_left_2 =Pose2d(Translation2d(16.54 - 2.784, 2.591),Rotation2d(-35*pi/180+pi))
        self.pose_red_left_1 =Pose2d(Translation2d(16.54 - 6.0, 2.45),Rotation2d(-35*pi/180+pi))
    ...
    def initialize(self):
        ...
        if DriverStation.getAlliance()==DriverStation.Alliance.kBlue:
            if currentY<4.03:
                ...
                if currentX<=5.9 and currentY>1.4:
                ...
                if currentX<=5.9 and currentY<8.069 - 1.4:
            ...
            if currentY<4.03:
                if currentX>=16.54 - 5.9 and currentY>1.4:
                ...
                if currentX>=16.54 -5.9 and currentY<8.069-1.4:
